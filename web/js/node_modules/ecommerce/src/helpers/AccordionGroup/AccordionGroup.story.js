...
const AccordionGroupStory = [
    ...
    {
        // just a mock-up, will be done proper when it will come to do Reviews
        title: (
            <div style={{ display: "flex", alignItems: "center", flexGrow: 1 }}>
                <span style={{ flexGrow: 1 }}>Reviews (6)</span>
...
storiesOf("AccordionGroup").add("default", () => (
    <div>
        <AccordionGroup accordions={AccordionGroupStory} />
    </div>
));

export default AccordionGroupStory;
