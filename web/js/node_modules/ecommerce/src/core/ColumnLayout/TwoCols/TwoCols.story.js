...
import VideoBoxStory, { VideoBoxStoryNike } from "./VideoBox/VideoBox.story";
...
storiesOf("TwoCols").add("default", () => TwoColsStory);
storiesOf("TwoCols").add("with full width", () => TwoColsStory2);
storiesOf("TwoCols").add("all full width", () => TwoColsStory3);
storiesOf("TwoCols").add("with full width and text", () => TwoColsStory4);
storiesOf("TwoCols").add("mixed with video", () => TwoColsStory5);
storiesOf("TwoCols").add("mixed items ratio", () => TwoColsStory6);
